$(document).ready(function(){
    ...
    var buttons = ["dogs", "bears", "tigers", "tapirs"];
    ...
    function imageClick(){
        ...
        const gif = gifCard.find('img');
        const icon = gifCard.find('i');

        const still = gif.attr('data-still');
        const animate = gif.attr('data-animate');
    ...
    // Watching for gif getting clicked
    $(document).on('click', '.giphy-image', imageClick);
    // listens for click of existing favorites
    $(document).on('click', '.btn-search', searchFavoriteButton);
